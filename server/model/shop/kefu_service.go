...
type Kefu struct {
	...
	NameI18n       string  `json:"nameI18n" form:"nameI18n" gorm:"column:name_i18n;type:text;comment:客服姓名多语言JSON;"`                      //姓名多语言
	...
	ContactID      *string `json:"contactId" form:"contactId" gorm:"column:contact_id;size:128;comment:对应ID;"`                           //对应ID
