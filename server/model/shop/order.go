...
type CreateOrder struct {
	...
	SettlementCurrency       string         `json:"settlementCurrency" form:"settlementCurrency" gorm:"column:settlement_currency;size:32;comment:订单结算币种标记;"`
	SettlementCurrencySymbol string         `json:"settlementCurrencySymbol" form:"settlementCurrencySymbol" gorm:"column:settlement_currency_symbol;size:32;comment:订单结算货币符号快照;"`
...
type OrderDetail struct {
	...
	PriceI18n string `json:"priceI18n" form:"priceI18n" gorm:"column:price_i18n;comment:商品多语言价格快照;type:text;"` //商品多语言价格快照
