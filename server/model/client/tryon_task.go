...
type TryonTask struct {
	...
	TemplateImageLower string     `json:"templateImageLower" form:"templateImageLower" gorm:"column:template_image_lower;type:text;comment:下装模板图(双件场景);"`
	...
	EnableParsing      bool       `json:"enableParsing" form:"enableParsing" gorm:"column:enable_parsing;default:false;comment:是否开启单件分割增强;"`
	ParsingModelKey    string     `json:"parsingModelKey" form:"parsingModelKey" gorm:"column:parsing_model_key;size:64;index;comment:分割模型key;"`
	ParsingStatus      string     `json:"parsingStatus" form:"parsingStatus" gorm:"column:parsing_status;size:20;default:'';comment:分割状态(disabled/pending/success/failed);"`
	ParsingError       string     `json:"parsingError" form:"parsingError" gorm:"column:parsing_error;size:500;comment:分割失败原因;"`
	RefinerModelKey    string     `json:"refinerModelKey" form:"refinerModelKey" gorm:"column:refiner_model_key;size:64;index;comment:精修模型key;"`
	...
	BaseCostPoints     int        `json:"baseCostPoints" form:"baseCostPoints" gorm:"column:base_cost_points;default:0;comment:基础试衣扣除试衣币;"`
	ParsingCostPoints  int        `json:"parsingCostPoints" form:"parsingCostPoints" gorm:"column:parsing_cost_points;default:0;comment:分割增强扣除试衣币;"`
	ParsingRefund      int        `json:"parsingRefund" form:"parsingRefund" gorm:"column:parsing_refund;default:0;comment:分割增强退还试衣币;"`
	RefinerCostPoints  int        `json:"refinerCostPoints" form:"refinerCostPoints" gorm:"column:refiner_cost_points;default:0;comment:精修额外扣除试衣币;"`
	RefinerRefund      int        `json:"refinerRefund" form:"refinerRefund" gorm:"column:refiner_refund;default:0;comment:精修退还试衣币;"`
