...
type TryonRechargeOrder struct {
	...
	SettlementCurrency       string         `json:"settlementCurrency" form:"settlementCurrency" gorm:"column:settlement_currency;size:32;default:default;comment:订单结算币种标记(如zh/en/mn);"`
	SettlementCurrencySymbol string         `json:"settlementCurrencySymbol" form:"settlementCurrencySymbol" gorm:"column:settlement_currency_symbol;size:32;default:¥;comment:订单结算货币符号快照;"`
