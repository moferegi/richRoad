...
type ModelCallLog struct {
	...
	TokenFingerprint string `json:"tokenFingerprint" form:"tokenFingerprint" gorm:"column:token_fingerprint;size:64;index;comment:调用token指纹;"`
	TokenSlot        string `json:"tokenSlot" form:"tokenSlot" gorm:"column:token_slot;size:32;comment:token槽位;"`
}
