...
const (
	...
	AssetTypeTryonPoint = "tryon_point"
)

// 积分记录管理 结构体  PointRecord
type PointRecord struct {
	global.GVA_MODEL
	AssetType      *string `json:"assetType" form:"assetType" gorm:"comment:资产类型(point积分/tryon_point试衣币);column:asset_type;size:20;default:point;index"` //资产类型
	...
	CurrentPoints  *int    `json:"currentPoints" form:"currentPoints" gorm:"comment:操作后的当前资产余额;column:current_points;"`                                  //当前资产余额
