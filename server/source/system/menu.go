...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	childMenus := []SysBaseMenu{
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["systemTools"], Path: "dbInspector", Name: "dbInspector", Component: "view/systemTools/dbInspector/index.vue", Sort: 10, Meta: Meta{Title: "数据库巡检与清理", Icon: "cpu"}},
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["client"], Path: "clientUser", Name: "clientUser", Component: "view/client/user/user.vue", Sort: 1, Meta: Meta{Title: "客户端用户", Icon: "user-filled"}},
