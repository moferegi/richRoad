...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/dbInspector/getOverview", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/dbInspector/autoFix", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/dbInspector/deleteRecordsByRange", V2: "POST"},
		...
		{Ptype: "p", V0: "888", V1: "/cpr/getPointRecordStats", V2: "GET"},
		...
		{Ptype: "p", V0: "888", V1: "/sysConfig/getPaymentConfig", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/sysConfig/getUniPreferredPayConfig", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/visitor/getKefuGuideStats", V2: "GET"},
		...
		{Ptype: "p", V0: "8881", V1: "/sysConfig/getPaymentConfig", V2: "GET"},
		{Ptype: "p", V0: "8881", V1: "/sysConfig/getUniPreferredPayConfig", V2: "GET"},
		{Ptype: "p", V0: "8881", V1: "/visitor/getKefuGuideStats", V2: "GET"},
