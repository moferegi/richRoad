...
export const getGeos = (params) => {
  return request({
    url: `/geo/getGeos?level=${params.level}&code=${params.code}`,
    method: 'get'
  })
}
...
export const findAddress = (params) => {
  return request({
    url: `/address/findAddress?ID=${params.id}`,
    method: 'get',
    params
  })
}
...
export const getAddressList = (params) => {
  return request({
    url: `/address/getAddressList?page=${params.page}&pageSize=${params.pageSize}`,
    method: 'get',
    params
  })
}
