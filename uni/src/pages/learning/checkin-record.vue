  ...
  <view class="checkin-record-container">
    ...
    <view class="page-hero">
      ...
      <view class="hero-content">
        ...
        <text class="hero-title">{{ t('learningCheckinRecordTitle') }}</text>
    ...
    <scroll-view class="list-scroll" scroll-y>
      ...
      <view v-for="(item, index) in recordList" :key="`${item.id}-${index}`" class="record-card">
        ...
        <view class="record-value-pill">
          <text class="record-value-text">+{{ item.pointAward }}</text>
        </view>
      </view>
...
.stats-bottom {
  margin-top: 24rpx;
  padding-top: 20rpx;
  border-top: 1rpx solid rgba(108, 91, 255, 0.1);
  display: flex;
  align-items: center;
  justify-content: space-between;
}
