  ...
  <div>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="shop_Tag" />
            <ExportExcel  template-id="shop_Tag" filterDeleted/>
            <ImportExcel  template-id="shop_Tag" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateTagFunc(scope.row)">编辑</el-button>
...
const getTableData = async() => {
  const table = await getTagList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
