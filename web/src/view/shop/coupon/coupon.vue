  ...
  <el-input v-model="searchInfo.type" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="日期" prop="CreatedAt"width="180">
            ...
            <el-table-column align="left" label="最低消费" prop="minSpend" width="120" />
    ...
    <template #default="scope">
        <span>{{ filterDataSource(dataSource.productID,scope.row.productID) }}</span>
            ...
            <el-table-column align="left" label="已领取" prop="claimed" width="120" />
   ...
   <template #default="scope">{{ formatDate(scope.row.endTime) }}</template>
    ...
    <template #default="scope">{{ formatBoolean(scope.row.status) }}</template>
        ...
        <el-table-column align="left" label="操作" fixed="right" :min-width="appStore.operateMinWith">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updateCouponFunc(scope.row)">编辑</el-button>
